...
public partial class MainPageViewModel : RunModel
{
    ...
    public IRelayCommand BurntCaloriesValidationCommand => new RelayCommand(()=> BurntCalories.Validate());
    ...
    private bool IsFormValid  => Distance.IsValid && RunningTime.IsValid && AverageSpeed.IsValid && BurntCalories.IsValid;
}
