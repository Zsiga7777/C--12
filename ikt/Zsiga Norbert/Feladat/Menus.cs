...
namespace Feladat
{
    public class Menus
    {
        public static async Task MainMenu(List<ChineseKreta.Database.Entities.StudentEntity> studentsDatas)
        {
            ...
            do
            {
                ...
                switch (input)
                {
                    ...
                    case 0:
                        {
                            Console.Clear();
                            await ConsoleFunctions.WriteStudentData(studentsDatas);
                            break;
                        }
                    case 1:
                        {
                            ...
                            Console.Clear();
                            ReusableMenu(studentsDatas.Select(x => x.Name).ToList());
                            break;
                        }
                    ...
                    case 2:
                        {
                            Console.Clear();
                            DataService.AddNewStudents(studentsDatas);
                            break;
                        }
                    case 3:
                        {
                            Console.Clear();
                            ModifyStudents(studentsDatas);
                            break;
                        }
                    case 4:
                        {
                            Console.Clear();
                            studentsDatas = DataService.DeleteStudentsData(studentsDatas);
                            break;
                        }
                }
